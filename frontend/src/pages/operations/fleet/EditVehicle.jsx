  ...
  const [form, setForm] = useState(
    vehicle
      ? {
          ...
          manufacturingYear: String(vehicle.year),
          vinNumber: vehicle.vin,
          engineNumber: vehicle.engineNo,
          licensePlate: vehicle.licensePlate,
          maxLoadCapacity: vehicle.loadCapacity,
          ...
          operationalStatus: vehicle.status === "Active" ? "Active" : vehicle.status === "On Trip" ? "On Trip" : vehicle.status === "In Maintenance" ? "In Maintenance" : "Retired",
        }
      : {}
  );
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }} className="bg-white border border-neutral-border rounded-xl p-6 shadow-soft-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input value={form.registrationNumber || ""} onChange={(e) => updateField("registrationNumber", e.target.value)} className={inputClass("registrationNumber")} />
              ...
              <div>
                ...
                <input value={form.vehicleName || ""} onChange={(e) => updateField("vehicleName", e.target.value)} className={inputClass("vehicleName")} />
              ...
              <div>
                ...
                <input value={form.vehicleModel || ""} onChange={(e) => updateField("vehicleModel", e.target.value)} className={inputClass("vehicleModel")} />
              ...
              <div>
                ...
                <input type="number" min="2000" max="2026" value={form.manufacturingYear || ""} onChange={(e) => updateField("manufacturingYear", e.target.value)} className={inputClass("manufacturingYear")} />
              ...
              <div>
                ...
                <input value={form.vinNumber || ""} onChange={(e) => updateField("vinNumber", e.target.value)} className={inputClass("vinNumber")} />
              ...
              <div>
                ...
                <input value={form.engineNumber || ""} onChange={(e) => updateField("engineNumber", e.target.value)} className={inputClass("engineNumber")} />
              ...
              <div className="sm:col-span-2">
                ...
                <input value={form.licensePlate || ""} onChange={(e) => updateField("licensePlate", e.target.value)} className={cn(inputClass("licensePlate"), "font-mono")} />
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-white border border-neutral-border rounded-xl p-6 shadow-soft-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input value={form.maxLoadCapacity || ""} onChange={(e) => updateField("maxLoadCapacity", e.target.value)} className={inputClass("maxLoadCapacity")} />
              ...
              <div>
                ...
                <input value={form.mileage || ""} onChange={(e) => updateField("mileage", e.target.value)} className={inputClass("mileage")} />
              ...
              <div className="sm:col-span-2">
                ...
                <input type="number" min="0" value={form.odometer || ""} onChange={(e) => updateField("odometer", e.target.value)} className={inputClass("odometer")} />
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="bg-white border border-neutral-border rounded-xl p-6 shadow-soft-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input value={form.acquisitionCost || ""} onChange={(e) => updateField("acquisitionCost", e.target.value)} className={inputClass("acquisitionCost")} />
              ...
              <div>
                ...
                <input value={form.insuranceProvider || ""} onChange={(e) => updateField("insuranceProvider", e.target.value)} className={inputClass("insuranceProvider")} />
