...
export default function FinanceDashboard() {
  const stats = [
    { label: "Total Revenue", value: "₹0", icon: TrendingUp, color: "success", trend: 0 },
    { label: "Total Expenses", value: "₹0", icon: IndianRupee, color: "danger", trend: 0 },
    { label: "Net Profit", value: "₹0", icon: DollarSign, color: "primary", trend: 0 },
    { label: "Fuel Cost", value: "₹0", icon: Fuel, color: "warning", trend: 0 },
    { label: "Maintenance Cost", value: "₹0", icon: Truck, color: "purple", trend: 0 },
    { label: "Insurance Cost", value: "₹0", icon: Shield, color: "cyan", trend: 0 },
    { label: "Profit Margin", value: "0", icon: BarChart3, color: "success", trend: 0 },
    { label: "Outstanding Invoices", value: "₹0", icon: Receipt, color: "danger", trend: 0 },
    { label: "Paid Invoices", value: "₹0", icon: CheckCircle, color: "success", trend: 0 },
    { label: "Monthly Spending", value: "₹0", icon: Wallet, color: "warning", trend: 0 },
  ];
